...
TC_E2E_001 = {
    ...
    "Covered":{
        ...
        "product_dropdown_values":["Retail Team","Wholesale Team","Auto Liability","General Liability",
                       "Excess Liability","Umbrella","Worker's Compensation",
                       "Hull & Liability","Construction","Cargo","Inland Marine",
                       "Directors & Officers","Pension Trust Liability","Employment Practice Liability","Fidelity",
                       "Professional Liability","Transactional Liability","Standalone Cyber",
                       "Blended Cyber","Political Risk","Trade Credit","Surety" ],
        "ProductSegment_dropdown_values":['Property','Casualty','Marine','Financial Lines','Cyber','Political Risk, Credit, and Surety'],
    },
    ...
    "taskupdateddetails": ['Medium','Prabhakaran Sundaram','MSIG Tester','No'], 
    "priority": "Medium",
    ...
    "Summary_queryList":['policy_number','attachment_point','policy_premium','business_type','policy_placement_type'],  
    "PolicyInfo":{
    "PolicyFields":['Premium','Attachment Point','Policy Placement Type','Class of Business','Placement Type','Mailed Date'],
    "premium":"1000",
...
TC_E2E_002 = {
    ...
    "FailureDetails":"Test",
    "Action":"Accept",
    "WorkFlowHistory":['Rejected','MSIG Tester','Stage Update','Stage updated from In Draft to Rejected'],
    "SubmissionColumnNames": ["Status", "Submission", "Submission ID","Product","Workflow Status"],
    "Covered":{
        "Product":"General Liability",
        "ProductSegment":"Property"
...
TC_Summary_001 = {
    ...
    "excepted_Page":"Home",
    "expected_company_name":"WIN-CON ENTERPRISES, INC",
...
TC_E2E_050={
    ...
    "SubmissionColumnNames": ["Status", "Submission", "Submission ID","Product","Workflow Status"],
     "Expected_email_Msg":"Testing Clearance Fields AutomationUnderwriter Name: Tony RolfLine Of Business: PropertyUnderwriter Assistant: John DoeConfidentiality: This message and any attachments are intended only for the use of the addressee and may contain information that is privileged and confidential. If the reader of the message is not the intended recipient or an authorized representative of the intended recipient, you are hereby notified that any dissemination of this communication is strictly prohibited. If you have received this communication in error, notify the sender immediately by return email and delete the message and any attachments from your system.",
...
TC_E2E_051={
    ...
    "SubmissionColumnNames": ["Status", "Submission", "Submission ID","Product","Workflow Status"],
     "Expected_email_Msg":"Insured Name: Rivian AutomotiveUnderwriter Name: Gary WoodConfidentiality: This message and any attachments are intended only for the use of the addressee and may contain information that is privileged and confidential. If the reader of the message is not the intended recipient or an authorized representative of the intended recipient, you are hereby notified that any dissemination of this communication is strictly prohibited. If you have received this communication in error, notify the sender immediately by return email and delete the message and any attachments from your system.",
...
TC_E2E_054 = {
    ...
    "SummaryTableHeader":['Product','Status','Eff. Date','Exp. Date','Assigned','Exp. Premium','Agency'],
    "SummaryTableData":["Worker's Compensation\nCurrent",'Wholesale Team\nCurrent','Under Review','12/01/2022','12/01/2023','-','-','Crest Ins'],
    "premiumAmount":"1000",
    "expectedTitle": "Great Western Lumber | Douglas Fir Timbers & Decking",
    "expectedQuestion": {
        "Auto": ["Do any employees use their own personal vehicle to transport goods or people or service clients?",
